...
#define __GMP_CC "gcc"
#define __GMP_CFLAGS "-ggdb -O2 -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4 -Wno-attributes -fdebug-prefix-map=/mnt/share/cygpkgs/gmp/gmp.x86_64/build=/usr/src/debug/gmp-6.3.0-1 -fdebug-prefix-map=/mnt/share/cygpkgs/gmp/gmp.x86_64/src/gmp-6.3.0=/usr/src/debug/gmp-6.3.0-1"
